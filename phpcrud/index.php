...
include 'action.php';
?>
<?php //echo "<pre>"; print_r($_SESSION['res_type']); echo "</pre>"; ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <?php if (isset($_SESSION['response'])) { ?>
                    <div class="text-center alert<?php echo $_SESSION['res_type']; ?> alert-dismissible">
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a href="index.php?edit=<?php echo $row['id']; ?>" class="badge badge-success">Edit</td>
                            </tr>
                        <?php } ?>
